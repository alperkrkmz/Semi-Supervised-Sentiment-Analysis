...
public class RandomForestView extends JPanel {
	
	public RandomForestModel rfModel = new RandomForestModel();
	public RandomForestIterationModel rfIterModel = new RandomForestIterationModel();
	...
	public RandomForestView() {
		...
		JLabel lblNaiveBayesIterasyonlu = new JLabel("Random Forest \u0130terasyonlu Sonu\u00E7lar");
	...
	public void rfCalistir(String dataYolu,int total, int egitimSayisi, int test, int yariEgitim, int egitilecek) throws Exception{
		double[][] sonuc = this.rfModel.rfRun(dataYolu, total, egitimSayisi, test, yariEgitim, egitilecek);
	...
	public void rfIterCalistir(String dataYolu,int total, int egitimSayisi, int test, int yariEgitim, int egitilecek,double esik) throws Exception{
		double[][] sonuc = this.rfIterModel.rfRun(dataYolu, total, egitimSayisi, test, yariEgitim, egitilecek,esik);
